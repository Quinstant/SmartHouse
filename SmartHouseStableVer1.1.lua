   ...
   for i = 1, #player do
    if e[3] == player[i] then 
		...
		elseif (string.sub(e[4],1,2) == "##") then
			...
			n=n+1
			break
		elseif ((e[4] == "#info")) then
			gpu.setForeground(color.yellow)
			print("["..n.."]"..nick.."§2Проверил инфу")
			n=n+1
			end
		end
   end 
